...
inline const ::std::string& ContentType_BYTES_Name(ContentType_BYTES value) {
  return ::google::protobuf::internal::NameOfEnum(
    ContentType_BYTES_descriptor(), value);
}
inline bool ContentType_BYTES_Parse(
    const ::std::string& name, ContentType_BYTES* value) {
  return ::google::protobuf::internal::ParseNamedEnum<ContentType_BYTES>(
...
inline const ::std::string& ContentType_DATETIME_Name(ContentType_DATETIME value) {
  return ::google::protobuf::internal::NameOfEnum(
    ContentType_DATETIME_descriptor(), value);
}
inline bool ContentType_DATETIME_Parse(
    const ::std::string& name, ContentType_DATETIME* value) {
  return ::google::protobuf::internal::ParseNamedEnum<ContentType_DATETIME>(
...
class FetchSuspended : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Mysqlx.Resultset.FetchSuspended) */ {
 public:
  FetchSuspended();
