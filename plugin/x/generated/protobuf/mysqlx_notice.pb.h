...
inline const ::std::string& Frame_Type_Name(Frame_Type value) {
  return ::google::protobuf::internal::NameOfEnum(
    Frame_Type_descriptor(), value);
}
inline bool Frame_Type_Parse(
    const ::std::string& name, Frame_Type* value) {
  return ::google::protobuf::internal::ParseNamedEnum<Frame_Type>(
...
inline const ::std::string& GroupReplicationStateChanged_Type_Name(GroupReplicationStateChanged_Type value) {
  return ::google::protobuf::internal::NameOfEnum(
    GroupReplicationStateChanged_Type_descriptor(), value);
}
inline bool GroupReplicationStateChanged_Type_Parse(
    const ::std::string& name, GroupReplicationStateChanged_Type* value) {
  return ::google::protobuf::internal::ParseNamedEnum<GroupReplicationStateChanged_Type>(
...
class GroupReplicationStateChanged : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Mysqlx.Notice.GroupReplicationStateChanged) */ {
 public:
  ...
  static inline const ::std::string& Type_Name(Type value) {
    return GroupReplicationStateChanged_Type_Name(value);
  }
  static inline bool Type_Parse(const ::std::string& name,
      Type* value) {
...
class ServerHello : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Mysqlx.Notice.ServerHello) */ {
 public:
  ServerHello();
  virtual ~ServerHello();
