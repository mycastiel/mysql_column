...
inline const ::std::string& Open_Condition_Key_Name(Open_Condition_Key value) {
  return ::google::protobuf::internal::NameOfEnum(
    Open_Condition_Key_descriptor(), value);
}
inline bool Open_Condition_Key_Parse(
    const ::std::string& name, Open_Condition_Key* value) {
  return ::google::protobuf::internal::ParseNamedEnum<Open_Condition_Key>(
...
class Open_Condition : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Mysqlx.Expect.Open.Condition) */ {
 public:
  ...
  static inline const ::std::string& Key_Name(Key value) {
    return Open_Condition_Key_Name(value);
  }
