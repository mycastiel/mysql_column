...
class Open_OneOfMessage : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:Mysqlx.Cursor.Open.OneOfMessage) */ {
 public:
  Open_OneOfMessage();
...
class Open : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:Mysqlx.Cursor.Open) */ {
 public:
  Open();
  virtual ~Open();
...
class Fetch : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:Mysqlx.Cursor.Fetch) */ {
 public:
  Fetch();
  virtual ~Fetch();
...
class Close : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:Mysqlx.Cursor.Close) */ {
 public:
  Close();
  virtual ~Close();
