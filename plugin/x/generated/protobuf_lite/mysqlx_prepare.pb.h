...
class Prepare_OneOfMessage : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:Mysqlx.Prepare.Prepare.OneOfMessage) */ {
 public:
...
class Prepare : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:Mysqlx.Prepare.Prepare) */ {
 public:
  Prepare();
  virtual ~Prepare();
...
class Execute : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:Mysqlx.Prepare.Execute) */ {
 public:
  Execute();
  virtual ~Execute();
...
class Deallocate : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:Mysqlx.Prepare.Deallocate) */ {
 public:
  Deallocate();
  virtual ~Deallocate();
