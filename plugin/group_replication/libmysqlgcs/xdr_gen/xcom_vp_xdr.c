...
xdr_synode_app_data_array(XDR *xdrs, synode_app_data_array *objp)
{
	...
	if (!xdr_array(xdrs, (char **)&objp->synode_app_data_array_val, (u_int *)&objp->synode_app_data_array_len, 1024, sizeof(synode_app_data), (xdrproc_t)xdr_synode_app_data))
		return (FALSE);
	return (TRUE);
}

bool_t
xdr_pax_msg_1_6(XDR *xdrs, pax_msg_1_6 *objp)
{
